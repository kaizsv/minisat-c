...
bool minisat_var_domain(struct minisat_solver *s, minisat_var v)
{
    return s->var_domain[v];
}

void minisat_set_var_domain(struct minisat_solver *s, minisat_var v, bool b)
{
    s->var_domain[v] = (char) b;
}
